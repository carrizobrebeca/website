...
const Carrusel = () => {
  const carruselItemsRef = useRef(null);

  useEffect(() => {
    let scrollAmount = 0;
    const carruselItems = carruselItemsRef.current;

    const autoScroll = () => {
      scrollAmount += 5; // Cambia la velocidad del desplazamiento
      carruselItems.scrollLeft = scrollAmount;

      // Reinicia el desplazamiento al final
      if (
        scrollAmount >=
        carruselItems.scrollWidth - carruselItems.clientWidth
      ) {
        scrollAmount = 0;
      }
  ...
  return (
    <div className={style.carrusel}>
      <div className={style.carruselItems} ref={carruselItemsRef}>
